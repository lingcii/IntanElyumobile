...
class WeatherController extends Controller
{
    ...
    {
        $municipalities = [
            'San Fernando' => [16.6159, 120.3209],
            'San Juan'     => [16.6908, 120.3228],
            'Bauang'       => [16.5333, 120.3333],
            'Agoo'         => [16.3217, 120.3667],
            'Luna'         => [16.8533, 120.3708],
            'Bangar'       => [16.7333, 120.3500],
            'Naguilian'    => [16.4833, 120.3833],
            'Bacnotan'     => [16.7214, 120.3347],
            'Balaoan'      => [16.8183, 120.4003],
            'Aringay'      => [16.3958, 120.3325],
            'Caba'         => [16.4292, 120.3344],
            'Rosario'      => [16.2500, 120.3500],
            'Pugo'         => [16.2000, 120.4000],
            'Tubao'        => [16.4333, 120.4000],
            'Sto. Tomas'   => [16.2842, 120.3861],
            'Santol'       => [16.7711, 120.4578],
            'Sudipen'      => [16.8378, 120.4589],
            'San Gabriel'  => [16.6711, 120.4789],
            'Bagulin'      => [16.6022, 120.4422],
