...
$pageTitle = 'PICTO Activity Logs';

// Extra head content for CSS
ob_start();
?>
    <!-- PITCO Activity Logs CSS -->
    <link rel="stylesheet" href="../../css/PITCO/activity-logs.css">
<?php
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Users</td>
                        <td>User "LUPTO Admin" logged in</td>
                        <td>LUPTO Admin</td>
                        <td><?= date('M d, Y h:i:s A', strtotime('-1 day')) ?></td>
                    </tr>
                    <tr>
