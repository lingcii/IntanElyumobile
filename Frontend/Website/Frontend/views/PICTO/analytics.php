...
<div class="pa-kpi-grid">
    ...
    <div class="pa-kpi-card">
        <div class="pa-kpi-icon purple"><i class="fas fa-user-check"></i></div>
        <div class="pa-kpi-info"><h4>Active Users</h4><p id="kpiUsers">—</p></div>
    </div>
    <div class="pa-kpi-card">
        <div class="pa-kpi-icon green"><i class="fas fa-check-circle"></i></div>
    ...
    <div class="pa-kpi-card">
        <div class="pa-kpi-icon red"><i class="fas fa-star"></i></div>
        <div class="pa-kpi-info"><h4>Top Tourist Spot</h4><p id="kpiTopSpot" style="font-size:14px; font-weight:700;">—</p></div>
    </div>
</div>
...
<div class="card" style="margin-bottom:20px;">
    ...
    <div class="card-body" style="padding-top:28px;">
        <div class="pa-podium-row" id="muniPodium">
            <div class="pa-loading"><i class="fas fa-spinner fa-spin"></i> Loading rankings...</div>
        </div>
...
<style>
.pa-auto-refresh { display:flex; align-items:center; gap:6px; font-size:12px; color:var(--text-secondary); cursor:pointer; user-select:none; }
.pa-auto-refresh input { accent-color:var(--lupto-primary); }
.pa-export-group { display:flex; gap:4px; }
