...
(async function dashboardInit() {
    ...
    var backendUrl = window.backendUrl || 'https://pig-paul-savings-headline.trycloudflare.com';
        ...
        if (searchInput && searchResults) {
            searchInput.addEventListener('input', async (e) => {
                ...
                if (!allDestinationsForSearch && !isFetching) {
                    isFetching = true;
                    try {
                        const backendUrl = window.backendUrl || 'https://pig-paul-savings-headline.trycloudflare.com';
                        const res = await fetch(backendUrl + '/api/public/map');
