...
<div class="magic-nav hidden" id="magic-nav">
    <div class="magic-nav-bg">
        <svg class="magic-nav-svg" id="magic-nav-svg" viewBox="0 0 448 66" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Dynamic color tint -->
            <path id="magic-nav-path-tint" d="" fill="#38bdf8" opacity="0.2" />
            <!-- Top gloss line -->
    ...
    <div class="magic-nav-items">
        <a href="#" class="magic-nav-item active" data-index="0" data-view="dashboard" data-color="#38bdf8" onclick="navigateTo('dashboard'); return false;">
            <span class="icon">
        ...
        <a href="#" class="magic-nav-item" data-index="1" data-view="map" data-color="#818cf8" onclick="navigateTo('map'); return false;">
            <span class="icon">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="#" class="magic-nav-item" data-index="2" data-view="itinerary" data-color="#34d399" onclick="navigateTo('itinerary'); return false;">
            <span class="icon">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="#" class="magic-nav-item" data-index="3" data-view="leaderboard" data-color="#fb923c" onclick="navigateTo('leaderboard'); return false;">
            <span class="icon">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="text">Ranks</span>
        </a>
        <a href="#" class="magic-nav-item" data-index="4" data-view="profile" data-color="#ef4444" onclick="navigateTo('profile'); return false;">
            <span class="icon">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="magic-circle" id="magic-indicator" style="background: radial-gradient(circle at 38% 32%, rgba(56, 189, 248, 0.93), rgba(56, 189, 248, 0.73));">
