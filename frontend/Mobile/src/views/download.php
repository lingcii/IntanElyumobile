...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Dedicated Hero QR Code Card */
    .hero-qr-card {
      background: #ffffff;
      border-radius: 24px;
      padding: 30px 26px;
      box-shadow: 0 20px 45px -10px rgba(0, 0, 0, 0.35), 0 0 0 1px rgba(255, 255, 255, 0.2);
      text-align: center;
      color: #0f172a;
      display: flex;
      flex-direction: column;
    ...
    /* Section A: Province Overview Pillars */
    .pillars-grid {
      display: grid;
    ...
    /* Section C: Spotlight Tourist Attractions */
    .spots-grid {
      display: grid;
      grid-template-columns: repeat(3, 1fr);
      gap: 26px;
    ...
    /* Section D: Partner Discounts & Vouchers */
    .vouchers-grid {
      display: grid;
      grid-template-columns: repeat(4, 1fr);
      gap: 22px;
    ...
    /* ─────────────────────────────────────────────────────────────────────────────
       ...
       ───────────────────────────────────────────────────────────────────────────── */
    .portal-footer {
      background: linear-gradient(180deg, #1e3a8a 0%, #172554 50%, #0f172a 100%);
      color: #ffffff;
    ...
    @media (max-width: 768px) {
      ...
      .muni-search-input { width: 100%; min-width: 0; }
      .muni-controls-row { flex-direction: column; align-items: stretch; }
    }
    ...
    @media (max-width: 480px) {
      ...
      .hero-stats-strip { flex-direction: column; gap: 14px; }
    }
  </style>
</head>
<body>
      ...
      <div class="hero-right-col reveal-on-scroll delay-2" id="hero-qr-card-wrap">
        <div class="hero-qr-card">
          ...
          <p class="hero-qr-caption">
            Point your phone's camera at the QR code above or tap the button below to install on Android.
          </p>
