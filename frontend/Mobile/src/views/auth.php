    ...
    <div class="auth-top">
        ...
        <div class="wave-bottom">
            <svg viewBox="0 0 2000 100" preserveAspectRatio="none">
                ...
                <path class="wave-layer wave-3" fill="url(#authWaveGrad3)" d="M0,70 C250,120 250,20 500,70 C750,120 750,20 1000,70 C1250,120 1250,20 1500,70 C1750,120 1750,20 2000,70 L2000,160 L0,160 Z"></path>
            </svg>
        </div>
    </div>
